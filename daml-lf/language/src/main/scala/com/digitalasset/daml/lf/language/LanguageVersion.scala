...
object LanguageVersion {
  ...
  object Features {
    val default = v1_6
    val arrowType = default
    val optional = default
    val partyOrdering = default
    val partyTextConversions = default
    val shaText = default
    val contractKeys = default
    val textMap = default
    val complexContactKeys = default
    val noExerciseActor = default
    val numberParsing = default
    val coerceContractId = default
